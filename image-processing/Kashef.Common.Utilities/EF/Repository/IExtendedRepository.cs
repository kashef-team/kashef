...
namespace Kashef.Common.Utilities.EF.Repository
{
    ...
    {
        /// <summary>
        /// Sets added entities into the repository. 
        /// When calling Commit() method in UnitOfWork 
        /// these changes will be saved into the storage
        /// </summary>
        /// <param name="items">Collection of added items</param>
        ...
        void Modify(params TEntity[] items);

        /// <summary>
        /// Sets deleted entities into the repository. 
        /// When calling Commit() method in UnitOfWork 
        /// these changes will be saved into the storage
        /// </summary>
        /// <param name="items">Collection of items with changes</param>
